...
<!-- Form horizontal -->
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            <?= form_open(base_url('shipments'), array('class'=> 'form-horizontal'));?>
                <fieldset class="content-group">
                    ...
                    <div class="form-group pt-15">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_predavanje_posiljke, 'Kuriru na svojim vratima', false); ?>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_predavanje_posiljke, 'U VINTAX express poslovnici', false); ?>
                    ...
                    <div class="form-group pt-15 vintax_poslovnice" style="display: none">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_vintax_poslovnice, 'Zagreb (Savska cesta 84 - poslovni centar na 1. katu zgrade Peveca)', false); ?>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_vintax_poslovnice, 'Slavonski Brod (Ulica Nikole Zrinskog 46A)', false); ?>
                    ...
                    <div class="form-group pt-15">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_dostava_posiljke, 'Na vrata primatelja', false); ?>
                                    Na vrata primatelja
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_dostava_posiljke, 'U VINTAX express poslovnicu', false); ?>
                    ...
                    <div class="form-group pt-15">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_ambalaza, 'Imam svoju ambalažu za dostavu', false); ?>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_ambalaza, 'Želim VINTAX ambalažu za dostavu', false); ?>
                ...
                <fieldset class="content-group">
                    ...
                    <div class="row col-md-offset-2" style="margin-bottom: 40px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="label-block text-center">
                                <span class="label label-primary">Teženia paketa (u kg)</span>
                            </div>
                        </div>
                    </div>
