...
function is_radio_checked($field, $text='', $shipment = ''){
    return (set_radio($field,$text) or $shipment->$field == $text) ?
        true:false;
}


function is_checkbox_checked($field, $text='', $shipment = ''){
    return (set_checkbox($field,$text) or $shipment->$field == $text) ?
        true:false;
}
...
$ta_opis_sadrzaja = array(
    "name"          => "opis_sadrzaja",
    "value"         => set_value('opis_sadrzaja') == '' ? $shipment->opis_sadrzaja : set_value('opis_sadrzaja'),
    "required"      => "true",
    "class"         => "form-control",
    "rows"          => "5",
    "cols"          => "5",
...
$ta_napomena = array(
    ...
    "value"         => set_value('posebne_napomene') == '' ? $shipment->posebne_napomene : set_value('posebne_napomene'),
    "required"      => "true",
    "class"         => "form-control",
    "rows"          => "5",
    "cols"          => "5",
...
$pos_ime = array(
    ...
    "value"         => set_value('posiljatelj_ime') == '' ? $shipment->posiljatelj_ime : set_value('posiljatelj_ime'),
...
$pos_adresa = array(
    ...
    "value"         => set_value('posiljatelj_adresa') == '' ? $shipment->posiljatelj_adresa : set_value('posiljatelj_adresa'),
...
$pos_grad = array(
    ...
    "value"         => set_value('posiljatelj_grad') == '' ? $shipment->posiljatelj_grad : set_value('posiljatelj_grad'),
...
$pos_drzavu = array(
    ...
    "value"         => set_value('posiljatelj_drzavu') == '' ? $shipment->posiljatelj_drzavu : set_value('posiljatelj_drzavu'),
...
$pos_postanski_broj = array(
    ...
    "value"         => set_value('posiljatelj_zip') == '' ? $shipment->posiljatelj_zip : set_value('posiljatelj_zip'),
...
$pos_telefon = array(
    ...
    "value"         => set_value('posiljatelj_telefon') == '' ? $shipment->posiljatelj_telefon : set_value('posiljatelj_telefon'),
...
$pos_email = array(
    ...
    "value"         => set_value('posiljatelj_email') == '' ? $shipment->posiljatelj_email : set_value('posiljatelj_email'),
...
$prim_ime = array(
    "name"          => "primatelj_ime",
    "value"         => set_value('primatelj_ime') == '' ? $shipment->primatelj_ime : set_value('primatelj_ime'),
...
$prim_adresa = array(
    ...
    "value"         => set_value('primatelj_adresa') == '' ? $shipment->primatelj_adresa : set_value('primatelj_adresa'),
...
$prim_grad = array(
    "name"          => "primatelj_grad",
    "value"         => set_value('primatelj_grad') == '' ? $shipment->primatelj_grad : set_value('primatelj_grad'),
...
$prim_drzavu = array(
    ...
    "value"         => set_value('primatelj_drzavu') == '' ? $shipment->primatelj_drzavu : set_value('primatelj_drzavu'),
...
$prim_postanski_broj = array(
    "name"          => "primatelj_zip",
    "value"         => set_value('primatelj_zip') == '' ? $shipment->primatelj_zip : set_value('primatelj_zip'),
...
$prim_telefon = array(
    ...
    "value"         => set_value('primatelj_telefon') == '' ? $shipment->primatelj_telefon : set_value('primatelj_telefon'),
    "placeholder"   => "Unesite poštanski broj primatelja",
    "class"         => "form-control",
    "required"      => "true",
    "maxlength"     => "25",
...
$f_cijena_odkupnine = array(
    ...
    "value"         => set_value('cijena_odkupnine') == 0 ? $shipment->cijena_odkupnine : set_value('cijena_dokupnine'),
    "placeholder"   => "400",
    "class"         => "form-control",
    "maxlength"     => "5",
    "minlength"     => "0",
...
$cb_garancija = array(
    ...
    'checked'       => $shipment->garancija_isporuke != '' or set_checkbox('garancija_isporuke','garancija_isporuke') ? true : false,
...
$f_paket_visina = array(
    "name"          => "paket_visina",
    "value"         => set_value('paket_visina') == 0 ? $shipment->paket_visina : set_value('paket_visina'),
    "placeholder"   => "10",
    "class"         => "form-control",
    "maxlength"     => "3",
    "minlength"     => "1",
...
$f_paket_sirina = array(
    "name"          => "paket_sirina",
    "value"         => set_value('paket_sirina') == 0 ? $shipment->paket_sirina : set_value('paket_sirina'),
    "placeholder"   => "10",
    "class"         => "form-control",
    "maxlength"     => "3",
    "minlength"     => "1",
...
$f_paket_duzina = array(
    "name"          => "paket_duzina",
    "value"         => set_value('paket_duzina') == 0 ? $shipment->paket_duzina : set_value('paket_duzina'),
    "placeholder"   => "10",
    "class"         => "form-control",
    "maxlength"     => "3",
    "minlength"     => "1",
...
$f_paket_tezina = array(
    "name"          => "paket_tezina",
    "value"         => set_value('paket_tezina') == 0 ? $shipment->paket_tezina : set_value('paket_tezina'),
    "placeholder"   => "10",
    "class"         => "form-control",
    "maxlength"     => "3",
    "minlength"     => "1",
...
<!-- Form horizontal -->
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            ...
            <?= form_open(base_url('shipments/edit/' . $shipment->shipment_id), array('class'=> 'form-horizontal'));?>
                <fieldset class="content-group">
                    ...
                    <div class="form-group pt-15">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_predavanje_posiljke, 'Kuriru na svojim vratima', is_radio_checked('predavanje_posiljke','Kuriru na svojim vratima', $shipment)); ?>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_predavanje_posiljke, 'U VINTAX express poslovnici',  is_radio_checked('predavanje_posiljke', 'U VINTAX express poslovnici', $shipment)); ?>
                    ...
                    <div class="form-group pt-15 vintax_poslovnice" style="display: none">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="radio">
                                <label>
                                    <?php
                                    echo form_radio($f_vintax_poslovnice, 'Zagreb (Savska cesta 84 - poslovni centar na 1. katu zgrade Peveca)',
                                        is_radio_checked('predavanje_u_poslovnicu',"Zagreb (Savska cesta 84 - poslovni centar na 1. katu zgrade Peveca)", $shipment)
                                    ); ?>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_vintax_poslovnice, 'Slavonski Brod (Ulica Nikole Zrinskog 46A)',
                                        is_radio_checked('predavanje_u_poslovnicu', "Slavonski Brod (Ulica Nikole Zrinskog 46A)", $shipment)
                                    ); ?>
                    ...
                    <div class="form-group pt-15">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_dostava_posiljke, 'Na vrata primatelja',
                                        is_radio_checked('dostava_posiljke', 'Na vrata primatelja',$shipment)
                                    ); ?>
                                    Na vrata primatelja
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_dostava_posiljke, 'U VINTAX express poslovnicu',
                                        is_radio_checked('dostava_posiljke', 'U VINTAX express poslovnicu',$shipment)
                                    ); ?>
                    ...
                    <div class="form-group pt-15 vintax_poslovnice_dostava" style="display: none">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_vintax_poslovnice_dostava, 'Zagreb (Savska cesta 84 - poslovni centar na 1. katu zgrade Peveca)',
                                        is_radio_checked('dostava_u_poslovnicu', 'Zagreb (Savska cesta 84 - poslovni centar na 1. katu zgrade Peveca)',$shipment)
                                        ); ?>
                                    Zagreb (Savska cesta 84 - poslovni centar na 1. katu zgrade Peveca)
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_vintax_poslovnice_dostava, 'Slavonski Brod (Ulica Nikole Zrinskog 46A)',
                                        is_radio_checked('dostava_u_poslovnicu', 'Slavonski Brod (Ulica Nikole Zrinskog 46A)',$shipment)
                                    ); ?>
                                    Slavonski Brod (Ulica Nikole Zrinskog 46A)
                                </label>
                            </div>
                    ...
                    <div class="form-group pt-15">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_ambalaza, 'Imam svoju ambalažu za dostavu',
                                        is_radio_checked('ambalaza', 'Imam svoju ambalažu za dostavu', $shipment)
                                    ); ?>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($f_ambalaza, 'Želim VINTAX ambalažu za dostavu',
                                        is_radio_checked("ambalaza", "Želim VINTAX ambalažu za dostavu", $shipment)); ?>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="checkbox">
                                <label>
                                    <div>
										<span class="checked">
                                            <?php echo form_checkbox($cb_amalaza, 'Koverta s mjehurićima M (srednja)',
                                                is_checkbox_checked('vintax_ambalaza', 'Koverta s mjehurićima M (srednja)', $shipment)
                                            ); ?>
										</span>
                                    </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    <div>
										<span class="checked">
                                            <?php echo form_checkbox($cb_amalaza, 'Koverta s mjehurićima S (mala)',
                                                is_checkbox_checked('vintax_ambalaza', 'Koverta s mjehurićima S (mala)', $shipment)
                                            ); ?>
										</span>
                                    </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    <div>
										<span class="checked">
                                            <?php echo form_checkbox($cb_amalaza, 'XL-velika kartonska kutija (velika)',
                                                is_checkbox_checked('vintax_ambalaza', 'XL-velika kartonska kutija (velika)', $shipment)
                                            ); ?>
										</span>
                                    </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    <div>
										<span class="checked">
                                            <?php echo form_checkbox($cb_amalaza, 'M-kartonska kutija (srednja)',
                                                is_checkbox_checked('vintax_ambalaza', 'M-kartonska kutija (srednja)', $shipment)
                                            ); ?>
										</span>
                                    </div>
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group pt-15">
                        ...
                        <div class="col-lg-8">
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($rf_dodatna_usluga, 'Paket sa otkupninom (pouzećem)',
                                        is_radio_checked('dodatna_usluga', 'Paket sa otkupninom (pouzećem)', $shipment)
                                    ); ?>
                            ...
                            <div class="radio">
                                <label>
                                    <?php echo form_radio($rf_dodatna_usluga, 'Paket bez otkupnine',
                                        is_radio_checked('dodatna_usluga', 'Paket bez otkupnine', $shipment)
                                    );?>
                                    Paket bez otkupnine
                                </label>
                            </div>
    ...
    <script type="text/javascript">
        ...
        if($("input[name=ambalaza]:checked").val() == "Želim VINTAX ambalažu za dostavu"){
            $(".vintax_ambalaza").show();
        }

        if($("input[name=dodatna_usluga]:checked").val() == "Paket sa otkupninom (pouzećem)"){
        ...
        function do_calculation(){
            ...
            if($('input[name=dodatna_usluga').val() == "Paket sa otkupninom (pouzećem)"){
                ...
                price += 5; //naknada za cijenu odkupnine
